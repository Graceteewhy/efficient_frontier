...
try:
    ...
    st.write('Enter correct stock tickers to be included in portfolio separated \ by commas WITHOUT spaces, e.g. "MA,FB,V,AMZN,JPM,BA"and hit Enter.')
...
fig_corr = px.imshow(corr_df, text_auto=False, title = 'Correlation between Stocks')
